...
- Integrated browser, keyboard controls, `ember-home`: E → exposed-canvas click at (1420,700) → Space leaves terminal visible, no active-play journal/pause button, and player Grounded at 6.0,9.3. Check connection → explicit return → Space shows Airborne with terminal hidden and link confirmed.
